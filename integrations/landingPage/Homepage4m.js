...
(function() {
    ...
    async function checkUserVerificationStatus() {
        try {
            ...
            const hasResetPassword = staffRecord.field_539 === "No";  // CORRECTED LOGIC - "No" means they HAVE reset
        ...
        setTimeout(() => {
            ...
            if (checkbox && continueBtn) {
                ...
                checkbox.addEventListener('click', function(e) {
                    log('Checkbox clicked', { checked: this.checked });
                    if (this.checked) {
                ...
                checkbox.addEventListener('change', function(e) {
                    log('Checkbox changed', { checked: this.checked });
                    if (this.checked) {
                        continueBtn.disabled = false;
                        continueBtn.style.background = '#00e5db';
                        continueBtn.style.color = '#0a2b8c';
