...
(function() {
  ...
  const CONFIG = {
    ...
    APP_ID: window.KNACK_APP_ID || '66e7968b9697f6002575c4b9',
    API_KEY: window.KNACK_API_KEY || '49f022e0-7f0b-11ef-811e-532fb97cb1ba',
    MAX_RETRIES: 3,
    RETRY_DELAY: 1000
  };
  ...
  function getHeaders() {
    return {
      'X-Knack-Application-Id': CONFIG.APP_ID,
      'X-Knack-REST-API-Key': CONFIG.API_KEY,
