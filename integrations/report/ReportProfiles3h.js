...
if (window.reportProfilesInitialized) {
  ...
  function getKnackHeaders() {
    ...
    const knackApiKey = (window.VESPA_CONFIG && window.VESPA_CONFIG.knackApiKey) || '';
  ...
  function addStyles() {
    ...
    if (!document.getElementById(styleId)) {
      ...
      linkElement.href = 'https://cdn.jsdelivr.net/gh/4Sighteducation/FlashcardLoader@main/integrations/landingPage/academicProfile1g.css'; // Update CSS path
