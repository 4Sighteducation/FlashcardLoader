// DirectReportProfiles.js - Standalone Student Profile Integration for VESPA Reports
...
(function() {
  ...
  // Initialize the script - this is the entry point
  function init() {
    debugLog("DirectReportProfiles initializing...");
  ...
  // Initialize the script when it loads
  init();
